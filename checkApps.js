...
sql.connect(config).then(pool => pool.request().query("SELECT * FROM dbo.Quarter_Applications")).then(res => { console.log(res.recordset); process.exit(0); }).catch(e => { console.error(e); process.exit(1); });
